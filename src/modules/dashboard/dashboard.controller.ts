...
export class DashboardController {
  ...
  @Get('retencion')
  @ApiOperation({
    summary: 'Retención de Socios (Riesgo de Fuga)',
    description: 'Evalúa el riesgo de fuga/desvinculación de los socios basándose en inactividad, saldo de ahorros y vinculación de cartera.',
  })
  @ApiQuery({ name: 'page',   required: false, example: 1,    description: 'Página (por defecto: 1)' })
  @ApiQuery({ name: 'limit',  required: false, example: 20,   description: 'Límite por página (por defecto: 20)' })
  @ApiQuery({ name: 'riesgo', required: false, example: 'Alto', description: 'Filtrar por riesgo: Alto | Medio | Bajo' })
  ...
  @ApiOperation({
    ...
    description: 'Segmenta a los socios en mora según su probabilidad de recuperación basándose en garantías, historial de pagos y antigüedad de mora.',
  })
  @ApiQuery({ name: 'page',     required: false, example: 1,    description: 'Página (por defecto: 1)' })
  @ApiQuery({ name: 'limit',    required: false, example: 20,   description: 'Límite por página (por defecto: 20)' })
