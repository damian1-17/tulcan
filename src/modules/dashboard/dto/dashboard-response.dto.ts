...
export class SocioRetencionDto {
  @ApiProperty() nroCliente: string;
  @ApiProperty() nombresSocio: string;
  @ApiProperty() saldoAhorro: number;
  @ApiProperty() diasInactividad: number;
  @ApiProperty() fechaUltMovimiento: string | null;
  @ApiProperty() tieneCredito: boolean;
  @ApiProperty() tieneCooplinea: boolean;
  @ApiProperty() probabilidadFuga: number;
  @ApiProperty() nivelRiesgo: string;
  @ApiProperty() motivoPrincipal: string;
}

export class RetencionResumenDto {
  @ApiProperty() totalRiesgoAlto: number;
  @ApiProperty() totalRiesgoMedio: number;
  @ApiProperty() saldoEnRiesgo: number;
}

export class RetencionResponseDto {
  @ApiProperty() resumen: RetencionResumenDto;
  @ApiProperty({ type: [SocioRetencionDto] }) data: SocioRetencionDto[];
...
export class SocioRecuperableDto {
  @ApiProperty() nroCliente: string;
  @ApiProperty() nombresSocio: string;
  @ApiProperty() nroOperacion: string;
  @ApiProperty() diasMora: number;
  @ApiProperty() saldoVencido: number;
  @ApiProperty() tipoGarantia: string;
  @ApiProperty() segmento: string;
  @ApiProperty() scoreRecuperacion: number;
  @ApiProperty() factorPositivo: string;
  @ApiProperty() ingresos: number;
}

export class RecuperabilidadResumenDto {
  @ApiProperty() totalAlta: number;
  @ApiProperty() totalMedia: number;
  @ApiProperty() totalBaja: number;
  @ApiProperty() montoAlta: number;
  @ApiProperty() montoMedia: number;
  @ApiProperty() montoBaja: number;
}

export class RecuperabilidadResponseDto {
  @ApiProperty() resumen: RecuperabilidadResumenDto;
  @ApiProperty({ type: [SocioRecuperableDto] }) data: SocioRecuperableDto[];
  @ApiProperty() page: number;
  @ApiProperty() limit: number;
  @ApiProperty() total: number;
}
